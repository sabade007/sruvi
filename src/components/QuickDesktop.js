      ...
      <div className="bg-white p-4 h-full flex flex-col justify-between shadow-2xl rounded-lg">
        <div>
          ...
          <h1 className="text-black text-md font-fira text-justify mt-2">
            At Sruvi Inc, our developers don{"'"}t just write code; they
            orchestrate desktop symphonies.Our developers are the Artisans of
            Algorithms and the Composers of Code.They sculpt sleek, efficient
            desktop applications that harmonize with your business
            needs.Intuitive interfaces, seamless functionality, and elegant
            design—our software sings to users.
          </h1>
        </div>
        <div>
        ...
        <div className="mt-8">
          ...
          <h1 className="text-black text-md font-fira text-justify">
            Whether it's productivity tools, utilities, or custom software—Sruvi
            Inc conducts the desktop orchestra.
          </h1>
          <Button
            variant="contained"
            style={{
