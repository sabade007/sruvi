...
const Navbar = () => {
  ...
  return (
    <div>
      {/* Desktop Code start */}
      <div className="sticky top-0 z-50  left-0 right-0 zero:hidden sm:hidden md:hidden lg:block xl:block xxl:block bg-white bg-opacity-50 backdrop-blur transition-all duration-300  ease-in-out">
      ...
      <div className="absolute bottom-0 left-0 z-50  bg-white dark:bg-white zero:block sm:block md:block lg:hidden xl:hidden xxl:hidden">
